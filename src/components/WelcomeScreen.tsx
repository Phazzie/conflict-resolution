...
import { Users, ChatCircle, Lock, Brain, Heart, TrendUp } from '@phosphor-icons/react'
import { PlayerRole, SessionData } from '@/types/session'

/**
 * Welcome screen component
 * Shows the main landing page with app introduction
 */
        ...
        <Card className="max-w-2xl mx-auto">
          ...
          <CardContent className="space-y-4 sm:space-y-6">
            ...
            <div className="pt-4 border-t">
              <Button onClick={onStartSession} size="lg" className="w-full text-sm sm:text-base mb-3">
